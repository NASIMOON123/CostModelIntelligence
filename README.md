Project title : Cost Model Intelligence

Project Overview:
    Cost Model Intelligence (CMI) is a smart system designed to automate the validation of vendor cost models against contract terms. The project focuses on reducing manual effort in procurement processes by extracting, analyzing, and comparing contract data with vendor-submitted cost data.This system ensures accuracy, consistency, and compliance in cost evaluation using data processing and intelligent validation techniques.
...
Modules Description
  ...
  3️⃣ Data Preparation for Validation
      ...
      Normalize formats (units, currency, naming conventions)
